...
import {
  ...
  getApplicationJobVal,
  getApplicationsReportVal,
  getSpecificCompanyValidation,
  searchCompanyByNameValidation,
...
companyRouter.get('/get/:companyId',
  isAuthenticated(),
  isAuthorized([roles.COMPANY_HR]),
  isValid(getSpecificCompanyValidation),
  asyncHandler(getSpecificCompany)
)
...
companyRouter.put('/:companyId',
  isAuthenticated(),
  isAuthorized([roles.COMPANY_HR]),
  isValid(updateCompanyValidation),
...
companyRouter.delete('/:companyId',
  isAuthenticated(),
  isAuthorized([roles.COMPANY_HR]),
  isValid(deleteCompanyValidation),
...
companyRouter.get('/search-company',
  ...
  isValid(searchCompanyByNameValidation),
